...
public class ExtractTest {
    ...
    public void testGetTimespanTwoTweets() {
        ...
        Timespan timespan1 = Extract.getTimespan(Arrays.asList(tweet2,tweet3));
        
        assertEquals(d1, timespan.getStart());
        assertEquals(d3, timespan.getEnd());
        
        assertEquals(d2, timespan1.getStart());
        assertEquals(d3, timespan1.getEnd());
    }
    ...
    public void testGetMentionedUsersNoMention() {
        ...
        assertTrue(mentionedUsers1.isEmpty());
    }
